  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="w-64 border-r bg-muted/10 h-full">
        ...
        <ScrollArea className="h-[calc(100vh-64px)]">
          <div className="space-y-4 p-4">
            <div className="space-y-1">
              ...
              <div className="space-y-1">
                <NavLink to="/chat" className="w-full flex justify-start">
                  <div
                    className={
                      "h-6 w-6 rounded-full bg-blue-500 mr-2 flex-shrink-0 flex items-center justify-center text-white text-xs"
                    }
                  >
                    G5
                  </div>
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "w-full flex justify-start items-center gap-2 bg-black/10 transition-all duration-200 rounded-2xl"
                      : "w-full flex justify-start items-center gap-2 transition-all duration-300"
                  }
                >
        ...
        <div className="p-4 border-t -mt-[70px] z-10 relative">
          <Button
            variant="default"
